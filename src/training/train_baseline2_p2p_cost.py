...
def run_training(cfg, data_dir, output_dir, seed=42, device="cpu"):
    ...
    eval_n_ctx = max(k_options)   # eval context = max training context (fills the slot bank)
    ...
    return fit_b2(cfg, sample_task, STATE_DIM, CONTROL_DIM, elem_dim, SLOTS, eval_n_ctx,
